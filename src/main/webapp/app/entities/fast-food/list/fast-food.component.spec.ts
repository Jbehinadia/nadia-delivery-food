...
describe('FastFood Management Component', () => {
  let comp: FastFoodComponent;
  let fixture: ComponentFixture<FastFoodComponent>;
  let service: FastFoodService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fast-food', component: FastFoodComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FastFoodComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fastFoods?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
