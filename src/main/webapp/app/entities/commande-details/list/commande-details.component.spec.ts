...
describe('CommandeDetails Management Component', () => {
  let comp: CommandeDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'commande-details', component: CommandeDetailsComponent }]),
      ...
      .overrideTemplate(CommandeDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.commandeDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
