...
public class DessertSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("id_dessert", table, columnPrefix + "_id_dessert"));
        columns.add(Column.aliased("nom_dessert", table, columnPrefix + "_nom_dessert"));
