...
describe('Boissons Management Component', () => {
  let comp: BoissonsComponent;
  let fixture: ComponentFixture<BoissonsComponent>;
  let service: BoissonsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'boissons', component: BoissonsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BoissonsComponent, '')
      .compileComponents();
