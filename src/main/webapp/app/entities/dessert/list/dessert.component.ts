...
export class DessertComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.dessertService
      ...
      .subscribe({
        next: (res: HttpResponse<IDessert[]>) => {
  ...
  trackId(_index: number, item: IDessert): number {
    return item.id!;
  }

  delete(dessert: IDessert): void {
    const modalRef = this.modalService.open(DessertDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IDessert[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
