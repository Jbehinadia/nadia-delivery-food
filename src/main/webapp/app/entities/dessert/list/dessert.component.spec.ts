...
describe('Dessert Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dessert', component: DessertComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.desserts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
